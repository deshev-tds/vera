  ...
  <body>
    ...
    <script>
      ...
      function logClass(type, scope) {
        ...
        if (type === "policy_reminder" || type === "policy_choice" || type === "policy_stagnation" || type === "policy_query_mutation" || type === "verifier_gradient") return "log-policy";
        return "log-other";
      }
